(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'material-ui', './preview', './active-overlay'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('material-ui'), require('./preview'), require('./active-overlay'));
  } else {
    var mod = {
      exports: {}
    };
    ...
    _createClass(CordovaPreview, [{
      ...
      value: function render() {
        ...
        return _jsx('div', {}, void 0, _jsx(_materialUi.IconButton, {
          ...
          onTouchTap: !this.state.isActive ? this.handleTouch : function () {}
        }, void 0, _jsx(_activeOverlay2.default, {
